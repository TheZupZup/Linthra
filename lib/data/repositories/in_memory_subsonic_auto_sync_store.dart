...
/// A non-persistent [SubsonicAutoSyncStore] for development and tests.
///
...
class InMemorySubsonicAutoSyncStore implements SubsonicAutoSyncStore {
  InMemorySubsonicAutoSyncStore([this._fingerprint]);
